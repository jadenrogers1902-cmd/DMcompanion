...
export default async function ChapterWorkspacePage({ params }: PageProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-5 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 rounded-xl border border-border bg-panel/50 p-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            <h2 className="text-sm font-semibold text-content">Play this chapter</h2>
            <p className="mt-1 text-xs text-faint">
              {hubMap
                ? <>Hub map: <span className="text-muted">{hubMap.title}</span>. Opening deploys it as the active map players land on.</>
      ...
      <section>
        <div className="mb-3 flex items-center justify-between gap-3">
          <h2 className="text-lg font-semibold text-content">Maps &amp; Scenes</h2>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
            {preparedMaps.map((map) => {
              ...
              return (
                ...
                >
                  <div className="flex h-full flex-col overflow-hidden rounded-xl border border-border bg-panel transition-colors hover:border-border-strong">
                    <div className="h-28 w-full bg-canvas">
                      {thumbnails[map.id] ? (
                    ...
                    <div className="flex flex-1 flex-col p-4">
                      <div className="flex items-start justify-between gap-2">
                        <h3 className="font-semibold text-content">{map.title}</h3>
                      ...
                      <div className="mt-auto flex flex-wrap items-center gap-x-3 gap-y-1 pt-3 text-xs text-faint">
