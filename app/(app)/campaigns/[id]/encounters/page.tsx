      ...
      <div className="flex items-start justify-between gap-4 mb-8">
        <div>
          <div className="flex items-center gap-2.5">
            <h1 className="text-2xl font-bold text-content">Encounters</h1>
      ...
      {encounters.length === 0 ? (
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 2xl:grid-cols-3">
          {encounters.map((encounter) => (
            ...
            >
              <div className="h-full rounded-lg border border-border bg-panel p-4 hover:border-border-strong transition-colors">
                <div className="flex items-start justify-between gap-3">
                  <h2 className="font-semibold text-content">{encounter.name}</h2>
                  <Badge
                    variant={
